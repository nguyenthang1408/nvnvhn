        ...
        <ul class="btn justify-content-center" style="font-size: 50px; display: inline-block; width: 100%;margin-top: 10px;" >
           ...
           <div class="col-12" style="">
            ...
            <div class="inputBox" style=" width: 80%;">
                <input type="text" name="tenmayy" id="tenmayy" placeholder="Tên Máy" style="width: 80%;text-align: center;margin-left: 21%; margin-top: 0%; font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div style="text-align: center;">
                <span id="idspan1"></span>
            </div>
            <div class="inputBox" style=" width: 80%;">
                <input type="date" name="ngaybatdau" placeholder="Ngày Bắt Đầu" style="width: 80%;text-align: center;margin-left: 21%; margin-top: 3%;font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div class="inputBox" style=" width: 80%;">
                <input type="date" name="ngaydukien" placeholder="Ngày Dự Kiến" style="width: 80%;text-align: center;margin-left: 21%;margin-top: 3%;font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div class="inputBox" style=" width: 80%;">
            ...
            <div class="inputBox" style=" width: 80%;">
                <input type="text" name="nhomthuchien" id="nhomthuchienId" placeholder="Người Thực Hiện" style="width: 35%;text-align: center;margin-left: 21%;margin-top: 3%;font-size: 40px;border-radius: 20px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);">
                <input type="text" name="mathe" id="matheId" placeholder="Mã Thẻ" style="width: 35%;text-align: center;margin-top: 3%;font-size: 40px;float: right;border-radius: 20px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);">
     ...
     <form action="" method="POST">
        <ul class="btn justify-content-center" style="font-size: 50px; display: inline-block; width: 100%;margin-top: 10px;" >
           ...
           <div class="col-12" style="">
            ...
            <div class="inputBox" style=" width: 80%;">
                <input type="text" name="tenmay" id="idtenmay" placeholder="Tên Line vd:line 2" style="width: 80%;text-align: center;margin-left: 22%; margin-top: 0%; font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div style="text-align: center;">
                <span id="idspan"></span>
            </div>
            ...
            <div class="inputBox" style=" width: 80%;">
                <input type="date" name="ngaybatdau" placeholder="Ngày Bắt Đầu" style="width: 80%;text-align: center;margin-left: 22%; margin-top: 3%;font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div class="inputBox" style=" width: 80%;">
                <input type="date" name="ngaydukien" placeholder="Ngày Dự Kiến" style="width: 80%;text-align: center;margin-left: 22%;margin-top: 3%;font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div class="inputBox" style=" width: 80%;">
            ...
            <div class="inputBox" style=" width: 80%;">
                <input type="text" name="nhomthuchienn" id="linenhomthuchien" placeholder="Người Thực Hiện" style="width: 35%;text-align: center;margin-left: 21%;margin-top: 3%;font-size: 40px;border-radius: 20px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);">
                <input type="text" name="mathee" id="linemathe" placeholder="Mã Thẻ" style="width: 35%;text-align: center;margin-top: 3%;font-size: 40px;float: right;border-radius: 20px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);">
             ...
             <div style="text-align: center;">
                 <button type="submit" class="btn btn-success" name="addluu" value="Thêm Dự Án" style="margin-top: 20px;margin-bottom: 20px; width: auto;font-size: 30px;">Xác Nhận</button>
             </div>
