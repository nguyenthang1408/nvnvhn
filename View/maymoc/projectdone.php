...
<section class="book" id="book" style="">
    ...
    <div class="row" style="" id="divtimkiem">
            ...
            <tr class="tr" style="">
               ...
               <th class="col-1 col-xs-1"id="idth" style="width: 5%;border: none;background: #D5E0E0;border-radius: 20px 20px 0 0;line-height: 70px;border: 3px solid white;">#</th> 
                <th class="col-1 col-xs-1"id="idth" style="width: 10%;border: none;background: #eb6ebb;border-radius: 20px 20px 0 0;line-height: 70px;border: 3px solid white;">Tên Máy</th>  
         ...
         <?php 
           ...
           ?>
            ...
            <tr style="background: white; text-align: center;">
                ...
                <td class="col-1 col-xs-1" style="width: 2%"><?php echo $stt; ?></td>
           ...
           ?>
            ...
            <tr style="background: white; text-align: center;">
                    ...
                    <td style='border: 3px solid #d5e0e0;' class="col-1 col-xs-1"> 
                        <a style="" href="../Controller/index.php?action=bieudoline1&id=<?php echo $value['id']; ?>"> <?php echo $value['tenmay'] ?> 
