    ...
    <div class="row" style="" id="divtimkiem">
            ...
            <tr class="tr" style="">
               <!--  <th style="font-size: 20px; text-align: center; width: 15%;" id="idth">#</th> -->
                ...
                <th class="col-1 col-xs-1"style="width: 30%;">Thành Viên</th>
            </tr>
        </thead>
        <tbody>
         <?php 
            ...
            <tr style="background: white; text-align: center;">
                ...
                ?>
                    ...
                    <?php if($pos !== false){ 
                     ...
                     <td style=""class="col-1 col-xs-1 tdtd"><span class="caret" onclick="<?php echo $string; ?>()" id="caret" style=""></span>
                ...
                <td style=' ' class="col-3 col-xs-3"><?php echo $value['nhomthuchien']; ?></td>
            ...
            $stt++;
             ...
             ?> 
                       <tr class="<?php echo $khoangtrang; ?>" style="background: #F5F5F5; text-align: center;display: none;">
                          ...
                          <td style='width: 30%'><?php echo $key['nhomthuchien']; ?></td>
