    ...
    <div class="row" style="" id="divtimkiem">
            ...
            <tr class="tr" style="">
               <!--  <th style="font-size: 20px; text-align: center; width: 15%;" id="idth">#</th> -->
                ...
                <th class="col-3 col-xs-3"style="width: 30%;background:#41f055;border: none;border-radius: 20px 20px 0 0;line-height: 70px;border: 3px solid white;">Thành Viên</th>
            </tr>
        </thead>
        <tbody>
         <?php 
            ...
            <tr style="background: white; text-align: center;">
                ...
                ?>
                    ...
                    <?php if($pos !== false){ 
                        ...
                        // $line = $db->getDatatiendo1($tableline,$tenmayline,$ngaybatdauline);
                ...
                <td style='border: 3px solid #d5e0e0; ' class="col-1 col-xs-1"><?php echo $value['nhomthuchien']; ?></td>
