    ...
    <div class="row" style="" id="divtimkiem">
            ...
            <tr class="" style="">
               <!--  <th style="font-size: 20px; text-align: center; width: 15%;" id="idth">#</th> -->
                <th style=" " class="col-1 col-xs-1"id="idth">機台</th>  

                <th style=" "class="col-1 col-xs-1">進度</th>
                <th style=" "class="col-1 col-xs-1">開始日期</th>
                <th style=" "class="col-1 col-xs-1">預期日期</th>
                <th style=" "class="col-1 col-xs-1">部門</th>
                <th style=" "class="col-3 col-xs-3">成員</th>
            </tr>
        </thead>
        <tbody>
         <?php 
           ...
           ?>
            ...
            <tr style="background: white; text-align: center;">
                ...
                <td style=' ' class="col-1 col-xs-1"><?php echo $value['nhomthuchien']; ?></td>
