           ...
           ?>
                ...
                ?>
                    ...
                    <?php if($pos !== false){ 
                     ...
                     <td style="border: 3px solid #d5e0e0;"class="col-1 col-xs-1 tdtd"><span class="caret" onclick="<?php echo $string; ?>()" id="caret" style=""></span>
                      ...
                      <a class="mobile"  style="justify-content: center;" href=""> <?php echo $value['tenmay'] ?> </a>
                     </td> 
            ...
            ?> 
                       <tr class="<?php echo $khoangtrang; ?>" style="background: #F5F5F5; text-align: center;display: none;">
                          <td style='border: 3px solid #d5e0e0;'><a style="color:red" href=""><?php echo $stt; ?>-<?php echo $key['tenmay']; ?></a></td>
...
function myFunction1() {
  ...
  var c = b.toUpperCase();
    ...
    if(x.value == c){
        ...
        window.location="../Controller/index.php?action=selectapsdata-cn#divtimkiem";
    }else{
