...
$table = 'users';
    ...
    $totalPage = ceil($totalRows/$rowsPerPage);
        $listPage = "";
          ...
          if($page>1){
                $listPage0 = '<li class="page-item"><a class="page-link" href="../Controller/index.php?action=usermanager-cn&page=1">Đầu</a></li>';
                $listPage1 = '<li class="page-item"><a class="page-link" href="../Controller/index.php?action=usermanager-cn&page='.($page-1).'"><</a></li>';
                  }else{
          ...
          if($page == $i){
            ...
            $listPage .= '<li class="page-item"><a class="page-link" href="../Controller/index.php?action=usermanager-cn&page='.$i.'">'.$i.'</a></li>';
          }
          if($page==$totalPage){
            ...
            if($page<$totalPage){
                $listPage2 = '<li class="page-item"><a class="page-link" href="../Controller/index.php?action=usermanager-cn&page='.($page+1).'">></a></li>';
                 $listPage3 = '<li class="page-item"><a class="page-link" href="../Controller/index.php?action=usermanager-cn&page='.$totalPage.'">Cuối</a></li>';
            }
    ...
    if(isset($_POST['add']))
    {
      ...
      if($db->Insertuser($table,$username,$password)){
        header('Location: ../Controller/index.php?action=usermanager-cn');
      }
    }
...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white" href="../Controller/index.php?action=adminmanager-cn">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../Controller/index.php?action=developeruser-cn">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="../Controller/index.php?action=test2-cn">Trang Chủ</a></li>
          ...
          <div class="row align-items-center justify-content-lg-between">
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="index.php?controller=may-moc&action=test2-cn" class="nav-link text-muted" target="_blank">Trang Chủ</a>
                </li>
                <li class="nav-item">
                  <a href="index.php?controller=may-moc&action=usermanager-cn" class="nav-link text-muted" target="_blank">Biểu Đồ</a>
                </li>
                <li class="nav-item">
                  <a href="index.php?controller=may-moc&action=usermanager-cn" class="nav-link text-muted" target="_blank">Trợ Giúp</a>
                </li>
                <li class="nav-item">
                  <a href="index.php?controller=may-moc&action=usermanager-cn" class="nav-link pe-0 text-muted" target="_blank">Số Điện Thoại</a>
                </li>
              </ul>
            </div>
          </div>
