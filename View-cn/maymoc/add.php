...
<body style="background:#c7deff">
   ...
   <a href="../Controller/index.php?action=test2#tableselectdata" style="font-weight: bold; border: 1px; text-decoration: none;" class="btn btn-success btn-lg aec">菜單</a>
        ...
        <ul class="btn justify-content-center" style="font-size: 50px; display: inline-block; width: 100%;margin-top: 10px;" >
           ...
           <div class="col-12" style="">
            ...
            <div class="inputBox" style=" width: 80%;">
                <input type="text" name="tenmayy" id="tenmayy" required ="required" placeholder="機台名稱" style="width: 80%;text-align: center;margin-left: 21%; margin-top: 0%; font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div style="text-align: center;">
                <span id="idspan1"></span>
            </div>
            <div class="inputBox" style=" width: 80%;">
                <input type="date" name="ngaybatdau" required ="required" placeholder="開始日期" style="width: 80%;text-align: center;margin-left: 21%; margin-top: 3%;font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div class="inputBox" style=" width: 80%;">
                <input type="date" name="ngaydukien" required ="required" placeholder="預期日期" style="width: 80%;text-align: center;margin-left: 21%;margin-top: 3%;font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div class="inputBox" style=" width: 80%;">
            ...
            <div class="inputBox" style=" width: 80%;">
                <input type="text" name="nhomthuchien" required ="required" id="matheId" placeholder="成員" style="width: 35%;text-align: center;margin-left: 21%;margin-top: 3%;font-size: 40px;border-radius: 20px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);">
                <input type="text" name="mathe" required ="required" id="nhomthuchienId" placeholder="工號" style="width: 35%;text-align: center;margin-top: 3%;font-size: 40px;float: right;border-radius: 20px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);">
     ...
     <form action="" method="POST">
        <ul class="btn justify-content-center" style="font-size: 50px; display: inline-block; width: 100%;margin-top: 10px;" >
           ...
           <div class="col-12" style="">
            ...
            <div class="inputBox" style=" width: 80%;">
                <input type="text" name="tenmay" id="idtenmay" required ="required" placeholder="機台 Line vd:line 2" style="width: 80%;text-align: center;margin-left: 22%; margin-top: 0%; font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div style="text-align: center;">
                <span id="idspan"></span>
            </div>
            ...
            <div class="inputBox" style=" width: 80%;">
                <input type="date" name="ngaybatdau" required ="required" placeholder="開始日期" style="width: 80%;text-align: center;margin-left: 22%; margin-top: 3%;font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div class="inputBox" style=" width: 80%;">
                <input type="date" name="ngaydukien" required ="required" placeholder="預期日期" style="width: 80%;text-align: center;margin-left: 22%;margin-top: 3%;font-size: 40px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);border-radius: 20px;">
            </div>
            <div class="inputBox" style=" width: 80%;">
            ...
            <div class="inputBox" style=" width: 80%;">
                <input type="text" name="nhomthuchienn" required ="required" id="linemathe" placeholder="工號" style="width: 35%;text-align: center;margin-left: 21%;margin-top: 3%;font-size: 40px;border-radius: 20px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);">
                <input type="text" name="mathee" required ="required" id="linenhomthuchien" placeholder="成員" style="width: 35%;text-align: center;margin-top: 3%;font-size: 40px;float: right;border-radius: 20px;box-shadow: 0px 3px 7px rgba(0, 0, 0, 0.7);">
             ...
             <div style="text-align: center;">
                 <button type="button" class="btn btn-success" name="add" data-bs-toggle="modal" data-bs-target="#exampleModal" value="加專案" style="margin-top: 20px;margin-bottom: 20px; width: auto;font-size: 30px;">加專案</button>
             </div>
  ...
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-body">
        <div style="margin-top:0px;">
             <ul style="font-size: 40px; display: inline; display: inline-block; width: 100%;margin-top: 0px; text-align: center;">
                ...
                <li style="display: inline; margin-left: 0%;width: 70%;"><span style="text-decoration: none;color:#FF6699; font-weight: bold;">Thêm Line</span></li>
              </ul>  
           </div>
           <div class="container">
                <div class="row" style=" display: grid;grid-template-columns: repeat(2, 1fr);column-gap: 1.6rem;grid-template-columns: 90% 10%;">
                    <table class="table table-hover" style="background:red">
                          <thead>
                          ...
                          <tbody>
                            <tr style="">
                              <th scope="row" style="">
                                <input type="text" style="text-align:center; margin-top: 7px;font-size: 20px;" required ="required" name="may1" class="form-control" placeholder="機台 1" id="may1">
                            </th>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaybatdaumay1" placeholder="開始日期 1" class="form-control" id="ngaybatdaumay1">
                              </td>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaydukienmay1" class="form-control" id="ngaydukienmay1" placeholder="預期日期 1">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="mathe1" placeholder="工號 1" class="form-control" id="nhomthuchienmay1">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="nhomthuchienmay1" placeholder="成員 1" class="form-control" id="mathe1">
                              </td>
                              <td>
                                  <div class="inputmayline1" id="inputmayline1" style="">
                                       <div class="searchdivmayline1" id="searchdivmayline1" style="">
                                       <input type="text" class="searchinputmayline1" id="searchinputmayline1" placeholder="搜索工號...">
                            ...
                            <tr>
                              <th scope="row" style="height:70px">
                                <input class="form-control" style="text-align:center;margin-top: 7px;font-size: 20px;" id="may2" type="text" placeholder="機台 2" required ="required" name="may2">
                            </th>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaybatdaumay2" placeholder="開始日期 2" class="form-control" id="ngaybatdaumay2">
                              </td>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaydukienmay2" placeholder="預期日期 2" class="form-control" id="ngaydukienmay2">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="mathe2" placeholder="工號 2" class="form-control" id="nhomthuchienmay2">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="nhomthuchienmay2" placeholder="成員 2" class="form-control" id="mathe2">
                              </td>
                              <td>
                                  <div class="inputmayline2" id="inputmayline2" style="">
                                       <div class="searchdivmayline2" id="searchdivmayline2" style="">
                                       <input type="text" class="searchinputmayline2" id="searchinputmayline2" placeholder="搜索工號...">
                            ...
                            <tr>
                              <th scope="row" style="height:70px">
                                   <input required ="required" style="text-align:center;margin-top: 7px;font-size: 20px;" class="form-control" placeholder="機台 3" type="text" id="may3" name="may3">
                              </th>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaybatdaumay3" placeholder="開始日期 3" class="form-control" id="ngaybatdaumay3">
                              </td>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaydukienmay3" placeholder="預期日期 3" class="form-control" id="ngaydukienmay3">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="mathe3" placeholder="工號 3" class="form-control" id="nhomthuchienmay3">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="nhomthuchienmay3"  placeholder="成員 3" class="form-control" id="mathe3">
                              </td>
                              <td>
                                  <div class="inputmayline3" id="inputmayline3" style="">
                                       <div class="searchdivmayline3" id="searchdivmayline3" style="">
                                       <input type="text" class="searchinputmayline3" id="searchinputmayline3" placeholder="搜索工號...">
                            ...
                            <tr>
                              <th scope="row" style="height:70px">
                                   <input class="form-control" style="text-align:center;margin-top: 7px;font-size: 20px;" id="may4" type="text" placeholder="機台 4" required ="required" name="may4">
                              </th>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaybatdaumay4" placeholder="開始日期 4" class="form-control" id="ngaybatdaumay4">
                              </td>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaydukienmay4" placeholder="預期日期 4" class="form-control" id="ngaydukienmay4">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="mathe4"  placeholder="工號 4" class="form-control" id="nhomthuchienmay4">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="nhomthuchienmay4" placeholder="成員 4" class="form-control" id="mathe4">
                              </td>
                              <td>
                                  <div class="inputmayline4" id="inputmayline4" style="">
                                       <div class="searchdivmayline4" id="searchdivmayline4" style="">
                                       <input type="text" id="searchinputmayline4" class="searchinputmayline4" placeholder="搜索工號...">
                            ...
                            <tr>
                              <th scope="row" style="height:70px">
                            <input class="form-control" id="may5" style="text-align:center;margin-top: 7px;font-size: 20px;" type="text" placeholder="機台 5" required ="required" name="may5">
                              </th>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaybatdaumay5" placeholder="開始日期 5" class="form-control" id="ngaybatdaumay5">
                              </td>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaydukienmay5" placeholder="預期日期 5" class="form-control" id="ngaydukienmay5">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="mathe5" placeholder="工號 5" class="form-control" id="nhomthuchienmay5">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="nhomthuchienmay5"  placeholder="成員 5" class="form-control" id="mathe5">
                              </td>
                              <td>
                                  <div class="inputmayline5" id="inputmayline5" style="">
                                       <div class="searchdivmayline5" id="searchdivmayline5" style="">
                                       <input type="text" id="searchinputmayline5" class="searchinputmayline5" placeholder="搜索工號...">
                            ...
                            <tr>
                              <th scope="row" style="height:70px">
                            <input required ="required" style="text-align:center;margin-top: 7px;font-size: 20px;" class="form-control" type="text" placeholder="機台 6" id="may6" name="may6">
                              </th>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaybatdaumay6" placeholder="開始日期 6" class="form-control" id="ngaybatdaumay6">
                              </td>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaydukienmay6" placeholder="預期日期 6" class="form-control" id="ngaydukienmay6">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="mathe6" placeholder="工號 6" class="form-control" id="nhomthuchienmay6">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="nhomthuchienmay6"  placeholder="成員 6" class="form-control" id="mathe6">
                              </td>
                              <td>
                                  <div class="inputmayline6" id="inputmayline6" style="">
                                       <div class="searchdivmayline6" id="searchdivmayline6" style="">
                                       <input type="text" id="searchinputmayline6" class="searchinputmayline6" placeholder="搜索工號...">
                            ...
                            <tr>
                              <th scope="row" style="height:70px">
                                 <input class="form-control" style="text-align:center;margin-top: 7px;font-size: 20px;" id="may7" type="text" placeholder="機台 7" required ="required" name="may7">
                              </th>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaybatdaumay7" placeholder="開始日期 7" class="form-control" id="ngaybatdaumay7">
                              </td>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaydukienmay7" placeholder="預期日期 7" class="form-control" id="ngaydukienmay7">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="mathe7"  placeholder="工號 7" class="form-control" id="nhomthuchienmay7">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="nhomthuchienmay7" placeholder="成員 7" class="form-control" id="mathe7">
                              </td>
                              <td>
                                  <div class="inputmayline7" id="inputmayline7" style="">
                                       <div class="searchdivmayline7" id="searchdivmayline7" style="">
                                       <input type="text" id="searchinputmayline7" class="searchinputmayline7" placeholder="搜索工號...">
                            ...
                            <tr>
                              <th scope="row" style="height:70px">
                            <input class="form-control" id="may8" style="text-align:center;margin-top: 7px;font-size: 20px;" type="text" placeholder="機台 8" required ="required" name="may8">
                              </th>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaybatdaumay8" placeholder="開始日期 8" class="form-control" id="ngaybatdaumay8">
                              </td>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaydukienmay8" placeholder="預期日期 8" class="form-control" id="ngaydukienmay8">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="mathe8" placeholder="工號 8" class="form-control" id="nhomthuchienmay8">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="nhomthuchienmay8"  placeholder="成員 8" class="form-control" id="mathe8">
                              </td>
                              <td>
                                  <div class="inputmayline8" id="inputmayline8" style="">
                                       <div class="searchdivmayline8" id="searchdivmayline8" style="">
                                       <input type="text" id="searchinputmayline8" class="searchinputmayline8" placeholder="搜索工號...">
                            ...
                            <tr>
                              <th scope="row" style="height:70px">
                            <input class="form-control" id="may9" style="text-align:center;margin-top: 7px;font-size: 20px;" type="text" placeholder="機台 9" required ="required" name="may9">
                              </th>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaybatdaumay9" placeholder="開始日期 9" class="form-control" id="ngaybatdaumay9">
                              </td>
                              <td>
                              ...
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="mathe9" placeholder="工號 9" class="form-control" id="nhomthuchienmay9">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="nhomthuchienmay9"  placeholder="成員 9" class="form-control" id="mathe9">
                              </td>
                              <td>
                                  <div class="inputmayline9" id="inputmayline9" style="">
                                       <div class="searchdivmayline9" id="searchdivmayline9" style="">
                                       <input type="text" id="searchinputmayline9" class="searchinputmayline9" placeholder="搜索工號...">
                            ...
                            <tr>
                              <th scope="row" style="height:70px">
                            <input class="form-control" id="may10" style="text-align:center;margin-top: 7px;font-size: 20px;" type="text" placeholder="機台 10" required ="required" name="may10">
                              </th>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaybatdaumay10" placeholder="開始日期 10" class="form-control" id="ngaybatdaumay10">
                              </td>
                              <td>
                                <input type="date" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="ngaydukienmay10" placeholder="預期日期 10" class="form-control" id="ngaydukienmay10">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="mathe10"  placeholder="工號 10" class="form-control" id="nhomthuchienmay10">
                              </td>
                              <td>
                                <input type="text" style="text-align:center;margin-top: 7px;font-size: 20px;" required ="required" name="nhomthuchienmay10" placeholder="成員 10" class="form-control" id="mathe10">
                              </td>
                              <td>
                                  <div class="inputmayline10" id="inputmayline10" style="">
                                       <div class="searchdivmayline10" id="searchdivmayline10" style="">
                                       <input type="text" id="searchinputmayline10" class="searchinputmayline10" placeholder="搜索工號...">
      ...
      <div class="modal-footer" style="background:#EEEEEE">
        ...
        <button type="submit" class="btn btn-primary" style="width: 10%;height: 100%" id="adddd" name="addluu">加專案</button>
      </div>
    </div>
  </div>
</div>
   ...
   window.onload = function()
{
  if(sessionStorage.getItem('key')!=1997){
      window.location="../Controller/index.php?action=test2-cn#tableselectdata";
  }
};
</script>
