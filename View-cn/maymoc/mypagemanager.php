...
if(isset($_POST['edit11'])){
      ...
      if($dfm1+$to2d1+$giacongvadathang1+$lapdatvachinhmay1+$buyoff1=='100')
      {
		  ...
		  {
		  	 header('location: ../Controller/index.php?action=mypagemanager-cn');
		  }
	  }else{
...
<body>
<div>
	<a class="btn btn-success" href="../Controller/index.php?action=mypage-cn" style="text-decoration:none;margin-top: 1%;margin-left: 1%;">Trang Chủ</a>
