...
if(isset($_GET['id'])){
           ...
           if(isset($_POST['edit']))
           {
            ...
            {
                header('Location: ../Controller/index.php?action=test2-cn#book');
            }
           } 
...
<nav style="">
   <a href="../Controller/index.php?action=test2-cn" class="btn btn-success" style="font-size:20px;margin-left: 10px; margin-top: 10px;">菜單</a>
</nav>
    ...
    <form action="" method="POST">
           <div>
             <ul style="font-size: 40px; display: inline; display: inline-block; width: 100%;margin-top: 0px;text-align: center;">
                <li style="display: inline; "><a href="#" style="text-decoration: none;" class="aec">進度</a></li>
              </ul>  
           </div>
             <div class="container">
                <div class="row">
                    <div class="col-lg-6"style="">
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">機台名稱:</label>
