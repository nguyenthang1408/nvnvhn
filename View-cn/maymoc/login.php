...
<body class="body" style="">
  ...
  <main>
    ...
    <h3 style="font-weight:bold;color:white;font-size: 70px;">VN Cable <br> 自動化</h3> <br>

      <h5 class="indigo-text" style="color:white !important; !important;font-weight:bold;">登入畫面</h5>
      <div class="section"></div>
      <div class="container">
        <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 5vw 10vh 5vw 10vh; border: 1px solid #EEE;background: rgba(0, 0, 0, 0.8) !important;">
          ...
          <form class="col s12" id="loginn" method="post">
            ...
            <center>
              <div class="row">
                <button type="submit" id="submitT" name="submit" style="width: 30vw;font-size: 25px;height: 8vh;" class="col s12 btn btn-large waves-effect indigo">登入</button>
              </div>
            </center>
        </div>
      </div>
