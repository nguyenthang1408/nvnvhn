...
<body>
  ...
  <div class="tiendo" >
     ...
     <div style="" data-bs-toggle="modal" data-bs-target="#giacongvadathang" data-bs-whatever="Gia Công Và Đặt Hàng" class="giacongvadathang">
      <h5 style="font-weight: bold;">加工,訂購<br> <span style="color:red;font-weight:bold;"><?php echo $datatiendo['giacongvadathang']; ?></span></h5>
     </div>
     <div style="" data-bs-toggle="modal" data-bs-target="#lapdatvachinhmay" data-bs-whatever="Lắp Đặt Và Chỉnh Máy" class="lapdatvachinhmay">
      <h5 style="font-weight: bold;">組裝，調整機台<br> <span style="color:red;font-weight:bold;"><?php echo $datatiendo['lapdatvachinhmay']; ?></span></h5>
     </div>
