...
<body>
    ...
    <div style="width: 100%;height: 70px;position: fixed;z-index: 61;">
        <h2><a href="../Controller/index.php?action=selectaecdata-cn#book" style="font-size: 25px;" class="btn btn-success"><i class="fa-solid fa-angles-left"></i>菜單</a></h2>   
    </div>
          ...
          <div style="" class="packages-divtable">
              ...
              <thead>
                <tr style="height: 20px;">
                    <th style="width: 20%;vertical-align: middle;" class="">機台名稱</th>    
                    <th style="width: 5%;vertical-align: middle;" class="">進度</th>
                    <th style="width: 7%;vertical-align: middle;" class="">開始日期</th>
                    <th style="width: 7%;vertical-align: middle;" class="">預期日期</th>
                    <th style="width: 7%;vertical-align: middle;" class="">完成时间(H)</th>
                    <th style="width: 5%;vertical-align: middle;" class="">全部小时数</th>
                    <th style="width: 5%;vertical-align: middle;" class="">一天中的时间(H)</th>
                    <th style="width: 5%;vertical-align: middle;" class="">实际时间(H)</th>
                    <th style="width: 5%;vertical-align: middle;" class="">效率(%)</th>
                    <th style="width: 5%;vertical-align: middle;" class="">随着时间的推移(H)</th>
                    <th style="width: 20%;vertical-align: middle;" class="">成員</th>
...
<script type="text/javascript">
    ...
    {
        document.getElementById('hidden285').event.preventDefault();
    }
</script>
