...
$table = 'users';
    ...
    if(isset($_POST['add']))
    {
      ...
      if($db->Insertuser($table,$username,$password)){
        header('Location: ../Controller/index.php?action=developer-cn');
      }
    }
...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../Controller/index.php?action=developer-cn">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../Controller/index.php?action=developeruser-cn">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="../Controller/index.php?action=mypage-cn">Trang Chủ</a></li>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="index.php?controller=may-moc&action=test2-cn" class="font-weight-bold" target="_blank">Automatic</a>
                for a better web.
              </div>
            </div>
...
<form method="POST" action=""> 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" method="POST">
          <input type="hidden" name="editname" id="editid">
           <div class="mb-3">
