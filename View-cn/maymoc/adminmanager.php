...
$db -> connect();
    ...
    if(isset($_POST['add']))
    {
      ...
      if($db->Insertuser($table,$username,$password)){
        header('Location: ../Controller/index.php?action=adminmanager-cn');
      }
    }
...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../Controller/index.php?action=adminmanager-cn">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../Controller/index.php?action=usermanager-cn">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Người Quản Lý</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0" id="idtablee">
                  <thead>
                    <tr>
                      ...
                      <th class="text-secondary text-xxs opacity-7" style="">Tùy Chọn</th>
                    </tr>
                  </thead>
                  <tbody>

                    <span style="margin-left:40%">Không Có Quyền Truy Cập</span>
                  </tbody>
                </table>
              </div>
            </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="../Controller/index.php?action=test2-cn" class="font-weight-bold" target="_blank">Automatic</a>
                for a better web.
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="../Controller/index.php?action=test2-cn" class="nav-link text-muted" target="_blank">Trang Chủ</a>
                </li>
                <li class="nav-item">
                  <a href="../Controller/index.php?action=test2-cn" class="nav-link text-muted" target="_blank">Biểu Đồ</a>
                </li>
                <li class="nav-item">
                  <a href="../Controller/index.php?action=test2-cn" class="nav-link text-muted" target="_blank">Trợ Giúp</a>
                </li>
                <li class="nav-item">
                  <a href="../Controller/index.php?action=test2-cn" class="nav-link pe-0 text-muted" target="_blank">Số Điện Thoại</a>
                </li>
              </ul>
            </div>
          </div>
